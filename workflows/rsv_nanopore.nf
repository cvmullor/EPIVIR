...
workflow RSV_NANOPORE {
    ...
    */
    ...
    /*
        SUBWORKFLOW: ASSEMBLY_TYPING_CLADE_VARIABLES - assembly, rsv typing/subtyping, and Nextclade variable determination based upon flu 'abricate_subtype'
    */
    ...
    */
    ...
    /*
        SUBWORKFLOW: NEXTCLADE_DATASET_AND_ANALYSIS_RSV - Nextclade dataset creation and analysis based on flu 'abricate_subtype' (~~for rsv)
    */
